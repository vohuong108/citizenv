  ...
  return (
    <BrowserRouter>
      <div className="App">
        <Header />
        <Routes>
          <Route exact path="/login" element={<PublicRoute haveFooter />}>
            <Route exact path='/login' element={<Login/>}/>
          </Route>
          <Route exact path="/register" element={<PrivateRoute haveFooter/>}>
            <Route exact path='/register' element={<Register/>}/>
          </Route>
          <Route exact path="/declare" element={<PrivateRoute haveFooter />}>
            <Route exact path='/declare' element={<Declare/>}/>
          </Route>
          <Route exact path="/edit/:id" element={<PrivateRoute haveFooter/>}>
            <Route exact path='/edit/:id' element={<Declare type="EDIT" />}/>
          </Route>
          <Route exact path="/profile" element={<PrivateRoute haveFooter/>}>
